          ...
          <div className="suc-inner">
            {loading ? (
              ...
              <>
                ...
                <p className="suc-sub">
                  Awesome, <strong>{nick}</strong>! The magic has been processed. Your items will appear shortly.
                </p>
                ...
                <div className="suc-btns">
                  ...
                  >
                    <Package size={16} /> View More Loot <ArrowRight size={16} />
                  </button>
                </div>

                <div className="suc-note">
                  <div className="suc-note-icon">
                    <div style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--ice)', boxShadow: '0 0 8px var(--ice)', marginTop: 4 }}></div>
                  </div>
                  <div className="suc-note-txt">
                    Your rank/items will sync in-game within <strong>5 minutes</strong>. Need help? Message <strong>@BIaziee</strong> on Telegram.
                  </div>
                </div>
              </>
            )}
