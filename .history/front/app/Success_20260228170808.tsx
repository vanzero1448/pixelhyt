...
export const Success: React.FC<Props> = ({ onNavigate }) => {
  ...
  const item = params.get("item") || "your purchase";
          ...
          <div className="suc-inner">
            ...
            <div className="suc-details">
              ...
              <div className="suc-row">
                ...
                <span className="suc-row-val">{nickname}</span>
              </div>
              <div className="suc-row">
            ...
            <div className="suc-ip">
              <span className="suc-ip-lbl">Play on</span>
              <span className="suc-ip-val">play.pixel.net</span>
              <button
